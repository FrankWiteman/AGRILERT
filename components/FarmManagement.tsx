...
// Added FarmManagementProps interface to fix TypeScript error in App.tsx
interface FarmManagementProps {
  user: any;
  setUser: (user: any) => void;
}

const FarmManagement: React.FC<FarmManagementProps> = ({ user, setUser }) => {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            ...
            <p className="text-xs text-slate-400">Managing tasks for {user.name}</p>
            ...
            {[
              ...
              <div key={task.id} className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100 group">
                <div className="flex items-center gap-4">
                  <input type="checkbox" checked={task.status === 'Completed'} className="w-5 h-5 rounded-lg accent-emerald-600" readOnly />
                  <div>
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-emerald-50 rounded-2xl">
                ...
                <p className="text-xl font-black text-emerald-900">{user.subscription} Real-Time</p>
